            ...
            <div class="col-md-6 mb-30">
                <h3>Редактирование данных</h3>
                  ...
                  <form action="#" method="post">
                    <label>Полное Имя</label> <!-- Username or email address -->
                    <input type="text" value="<?php echo $name; ?>" name="fullname">
                    
                    <label>Email адрес</label> <!-- Username or email address -->
                    <input type="text" value="<?php echo $email; ?>" name="email">
                    <h4>Адрес доставки</h4>
                    <label>Улица, дом, квартира</label> <!-- Username or email address -->
                    <input type="text" value="<?php echo $street; ?>" name="street">
                    
                    <label>Город</label> <!-- Username or email address -->
                    <input type="text" value="<?php echo $city; ?>" name="city">
                    
                    <label>Штат / Округ</label> <!-- Username or email address -->
                    <input type="text" value="<?php echo $state; ?>" name="state">
                    
                    <label>Страна
                    </label>
                    <select name="country" id="billing_country" class="country_to_state country_select" title="Country *">
                    ...
                    <input type="text" value="<?php echo $postcode; ?>" name="postcode">
                    
                    <label>Телефон</label>
                    <input type="text" value="<?php echo $phone; ?>" name="phone">

                    <label>Пароль <abbr class="required" title="required">*</abbr></label>
